package com.vitwale.vitwale.ChatBox;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void displayChatMessage() {
        ...
        adapter = new FirebaseListAdapter<ChatMessage>(this, ChatMessage.class, R.layout.list_item_chat, FirebaseDatabase.getInstance().getReference()
        ) {
            @Override
